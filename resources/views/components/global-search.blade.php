        ...
        <div class="search-modal" x-transition:enter="transition ease-out duration-300"
            ...
            <div class="search-results">
                <template x-for="result in results" :key="result.id">
                    <a :href="result.url" class="result-item" @click="closeSearch">
                        <!-- Mostrar datos de usuarios -->
                        <template x-if="result.model === 'user'">
                            <h3 x-text="result.name"></h3>
                        </template>
                        <!-- Mostrar datos de ventas -->
                        <template x-if="result.model === 'venta'">
                            <div>
                                <h3 x-text="result.name"></h3>
...
<script>
    function searchComponent() {
        return {
            ...
            query: '',
            results: [],
            items: @json($items), // Aquí los items son tanto 'users' como 'ventas'
...
<style>
    ...
    .search-modal {
        ...
        background-color: light-dark(#f1efec, #000000);
    ...
    .close-button {
        ...
        align-items: center;
        justify-content: center;
        color:light-dark(#ffffff,#f7f7f7);
        cursor: pointer;
        transition: all 0.3s ease;
    ...
    .search-input::placeholder {
        color:light-dark( rgba(8, 8, 8, 0.877), rgba(255, 255, 255, 0.6));
        /* color:light-dark(#000000,#0e0d0d); */
